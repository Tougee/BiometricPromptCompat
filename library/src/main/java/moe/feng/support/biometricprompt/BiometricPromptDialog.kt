...
class BiometricPromptDialog(context: Context, private val focusable: Boolean) : Dialog(context, R.style.TransparentDialog) {
    ...
    override fun show() {
        ...
        sheetContainer.measure(View.MeasureSpec.makeMeasureSpec(context.resources.displayMetrics.widthPixels, AT_MOST),
            View.MeasureSpec.makeMeasureSpec(context.resources.displayMetrics.heightPixels, AT_MOST))
        backDrawable.alpha = 0
    ...
    class Builder {
        private var bottomSheet: BiometricPromptDialog

        constructor(context: Context) {
            bottomSheet = BiometricPromptDialog(context, false)
        }

        constructor(context: Context, needFocus: Boolean) {
            bottomSheet = BiometricPromptDialog(context, needFocus)
        }
        ...
        fun create(): BiometricPromptDialog = bottomSheet

        fun show(): BiometricPromptDialog {
            bottomSheet.show()
            return bottomSheet
        }
    }
